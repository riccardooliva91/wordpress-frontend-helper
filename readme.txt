...
A set of handful tools to ease your life as a frontend WP developer.
...
Simply install this plugin and you will have its functionalities available on your WordPress installation. If you are
working with git repositories, you can pull this plugin here: https://github.com/riccardooliva91/wordpress-frontend-helper/
...
= 1.1 =
* Added media versioning functionality
* Added `if` method to the assets manager